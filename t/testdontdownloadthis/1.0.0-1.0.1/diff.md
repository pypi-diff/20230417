# Comparing `tmp/testdontdownloadthis-1.0.0.tar.gz` & `tmp/testdontdownloadthis-1.0.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "testdontdownloadthis-1.0.0.tar", last modified: Mon Apr 17 14:03:13 2023, max compression
+gzip compressed data, was "testdontdownloadthis-1.0.1.tar", last modified: Mon Apr 17 14:08:49 2023, max compression
```

## Comparing `testdontdownloadthis-1.0.0.tar` & `testdontdownloadthis-1.0.1.tar`

### file list

```diff
@@ -1,11 +1,11 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-17 14:03:13.297853 testdontdownloadthis-1.0.0/
--rw-r--r--   0 root         (0) root         (0)      314 2023-04-17 14:03:13.297853 testdontdownloadthis-1.0.0/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)       38 2023-04-17 14:03:13.297853 testdontdownloadthis-1.0.0/setup.cfg
--rw-r--r--   0 root         (0) root         (0)      527 2023-04-17 14:03:11.000000 testdontdownloadthis-1.0.0/setup.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-17 14:03:13.297853 testdontdownloadthis-1.0.0/testdontdownloadthis/
--rw-r--r--   0 root         (0) root         (0)    70957 2023-04-17 14:03:12.000000 testdontdownloadthis-1.0.0/testdontdownloadthis/__init__.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-04-17 14:03:13.297853 testdontdownloadthis-1.0.0/testdontdownloadthis.egg-info/
--rw-r--r--   0 root         (0) root         (0)      314 2023-04-17 14:03:13.000000 testdontdownloadthis-1.0.0/testdontdownloadthis.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      217 2023-04-17 14:03:13.000000 testdontdownloadthis-1.0.0/testdontdownloadthis.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-04-17 14:03:13.000000 testdontdownloadthis-1.0.0/testdontdownloadthis.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)       21 2023-04-17 14:03:13.000000 testdontdownloadthis-1.0.0/testdontdownloadthis.egg-info/top_level.txt
...
### Comparing `testdontdownloadthis-1.0.0/setup.py` & `testdontdownloadthis-1.0.1/setup.py`
...
### Comparing `testdontdownloadthis-1.0.0/testdontdownloadthis/__init__.py` & `testdontdownloadthis-1.0.1/testdontdownloadthis/__init__.py`
