# Comparing `tmp/jeff_api-1.1.3.tar.gz` & `tmp/jeff_api-1.1.4.tar.gz`
...
+gzip compressed data, was "jeff_api-1.1.4.tar", last modified: Sun Apr 16 23:11:01 2023, max compression
```

## Comparing `jeff_api-1.1.3.tar` & `jeff_api-1.1.4.tar`
...
+drwxr-xr-x   0 markcda   (1000) markcda   (1000)        0 2023-04-16 23:11:01.550566 jeff_api-1.1.4/
+-rw-------   0 markcda   (1000) markcda   (1000)     1087 2023-01-15 14:50:00.000000 jeff_api-1.1.4/LICENSE
+-rw-r--r--   0 markcda   (1000) markcda   (1000)      765 2023-04-16 23:11:01.548566 jeff_api-1.1.4/PKG-INFO
+-rw-r--r--   0 markcda   (1000) markcda   (1000)      254 2023-04-16 22:22:30.000000 jeff_api-1.1.4/README.md
+-rw-------   0 markcda   (1000) markcda   (1000)      497 2023-04-16 23:10:31.000000 jeff_api-1.1.4/pyproject.toml
+-rw-r--r--   0 markcda   (1000) markcda   (1000)       38 2023-04-16 23:11:01.550566 jeff_api-1.1.4/setup.cfg
+drwxr-xr-x   0 markcda   (1000) markcda   (1000)        0 2023-04-16 23:11:01.536566 jeff_api-1.1.4/src/
+drwxr-xr-x   0 markcda   (1000) markcda   (1000)        0 2023-04-16 23:11:01.546566 jeff_api-1.1.4/src/jeff_api/
+-rw-r--r--   0 markcda   (1000) markcda   (1000)      120 2023-04-16 22:46:34.000000 jeff_api-1.1.4/src/jeff_api/__init__.py
+-rw-r--r--   0 markcda   (1000) markcda   (1000)     3635 2023-04-16 23:01:35.000000 jeff_api-1.1.4/src/jeff_api/bridge.py
+-rw-r--r--   0 markcda   (1000) markcda   (1000)     1766 2023-04-16 23:09:48.000000 jeff_api-1.1.4/src/jeff_api/extension.py
+-rw-r--r--   0 markcda   (1000) markcda   (1000)      474 2023-04-16 22:31:38.000000 jeff_api-1.1.4/src/jeff_api/message.py
+-rw-r--r--   0 markcda   (1000) markcda   (1000)     3671 2023-04-16 23:02:10.000000 jeff_api-1.1.4/src/jeff_api/scenario.py
+-rw-r--r--   0 markcda   (1000) markcda   (1000)      188 2023-04-16 23:00:37.000000 jeff_api-1.1.4/src/jeff_api/tools.py
+drwxr-xr-x   0 markcda   (1000) markcda   (1000)        0 2023-04-16 23:11:01.548566 jeff_api-1.1.4/src/jeff_api.egg-info/
+-rw-------   0 markcda   (1000) markcda   (1000)      765 2023-04-16 23:11:01.000000 jeff_api-1.1.4/src/jeff_api.egg-info/PKG-INFO
+-rw-------   0 markcda   (1000) markcda   (1000)      321 2023-04-16 23:11:01.000000 jeff_api-1.1.4/src/jeff_api.egg-info/SOURCES.txt
+-rw-------   0 markcda   (1000) markcda   (1000)        1 2023-04-16 23:11:01.000000 jeff_api-1.1.4/src/jeff_api.egg-info/dependency_links.txt
+-rw-------   0 markcda   (1000) markcda   (1000)        9 2023-04-16 23:11:01.000000 jeff_api-1.1.4/src/jeff_api.egg-info/top_level.txt
```

### Comparing `jeff_api-1.1.3/LICENSE` & `jeff_api-1.1.4/LICENSE`

 * *Files identical despite different names*

### Comparing `jeff_api-1.1.3/PKG-INFO` & `jeff_api-1.1.4/PKG-INFO`
...
### Comparing `jeff_api-1.1.3/src/jeff_api/bridge.py` & `jeff_api-1.1.4/src/jeff_api/bridge.py`

 * *Files identical despite different names*

### Comparing `jeff_api-1.1.3/src/jeff_api/extension.py` & `jeff_api-1.1.4/src/jeff_api/extension.py`
...
### Comparing `jeff_api-1.1.3/src/jeff_api/scenario.py` & `jeff_api-1.1.4/src/jeff_api/scenario.py`

 * *Files identical despite different names*

### Comparing `jeff_api-1.1.3/src/jeff_api.egg-info/PKG-INFO` & `jeff_api-1.1.4/src/jeff_api.egg-info/PKG-INFO`
