# Comparing `tmp/nicegui-1.2.7.tar.gz` & `tmp/nicegui-1.2.8.tar.gz`
...
### Comparing `nicegui-1.2.7/LICENSE` & `nicegui-1.2.8/LICENSE`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/README.md` & `nicegui-1.2.8/README.md`
...
```diff
@@ -27,46 +27,47 @@
 joysticks - annotate and overlay images - interact with tables - navigate
 foldable tree structures - built-in timer to refresh data in intervals (even
 every 10 ms) - straight-forward data binding to write even less code -
 notifications, dialogs and menus to provide state of the art user interaction -
 shared and individual web pages - ability to add custom routes and data
 responses - capture keyboard input for global shortcuts etc. - customize look
 by defining primary, secondary and accent colors - live-cycle events and
-session data ## Installation ```bash python3 -m pip install nicegui ``` ##
-Usage Write your nice GUI in a file `main.py`: ```python from nicegui import ui
-ui.label('Hello NiceGUI!') ui.button('BUTTON', on_click=lambda: ui.notify
-('button was pressed')) ui.run() ``` Launch it with: ```bash python3 main.py
...
-Documentation and Examples The documentation is hosted at [https://nicegui.io/
-documentation](https://nicegui.io/documentation) and provides plenty of live
-demos. The whole content of [https://nicegui.io](https://nicegui.io) is
-[implemented with NiceGUI itself](https://github.com/zauberzeug/nicegui/blob/
-main/main.py). You may also have a look at our [in-depth examples](https://
-github.com/zauberzeug/nicegui/tree/main/examples) of what you can do with
-NiceGUI. ## Why? We at [Zauberzeug](https://zauberzeug.com) like [Streamlit]
-(https://streamlit.io/) but find it does [too much magic](https://github.com/
-zauberzeug/nicegui/issues/1#issuecomment-847413651) when it comes to state
-handling. In search for an alternative nice library to write simple graphical
-user interfaces in Python we discovered [JustPy](https://justpy.io/). Although
-we liked the approach, it is too "low-level HTML" for our daily usage. But it
-inspired us to use [Vue](https://vuejs.org/) and [Quasar](https://quasar.dev/
-) for the frontend. We have built on top of [FastAPI](https://
-fastapi.tiangolo.com/), which itself is based on the ASGI framework [Starlette]
-(https://www.starlette.io/) and the ASGI webserver [Uvicorn](https://
-www.uvicorn.org/) because of their great performance and ease of use. ##
-Contributing Thank you for your interest in contributing to NiceGUI! We are
-thrilled to have you on board and appreciate your efforts to make this project
-even better. As a growing open-source project, we understand that it takes a
-community effort to achieve our goals. That's why we welcome all kinds of
-contributions, no matter how small or big they are. Whether it's adding new
-features, fixing bugs, improving documentation, or suggesting new ideas, we
-believe that every contribution counts and adds value to our project. We have
-provided a detailed guide on how to contribute to NiceGUI in our
-[CONTRIBUTING.md](https://github.com/zauberzeug/nicegui/blob/main/
-CONTRIBUTING.md) file. We encourage you to read it carefully before making any
-contributions to ensure that your work aligns with the project's goals and
-standards. If you have any questions or need help with anything, please don't
-hesitate to reach out to us. We are always here to support and guide you
-through the contribution process. ### Included Web Dependencies See
-[DEPENDENCIES.md](https://github.com/zauberzeug/nicegui/blob/main/
-DEPENDENCIES.md) for a list of web frameworks NiceGUI depends on.
+session data - runs in Jupyter Notebooks and allows Python's interactive mode -
+auto-complete support for Tailwind CSS ## Installation ```bash python3 -m pip
+install nicegui ``` ## Usage Write your nice GUI in a file `main.py`: ```python
+from nicegui import ui ui.label('Hello NiceGUI!') ui.button('BUTTON',
+on_click=lambda: ui.notify('button was pressed')) ui.run() ``` Launch it with:
+```bash python3 main.py ``` The GUI is now available through http://localhost:
+8080/ in your browser. Note: NiceGUI will automatically reload the page when
+you modify the code. ## Documentation and Examples The documentation is hosted
+at [https://nicegui.io/documentation](https://nicegui.io/documentation) and
+provides plenty of live demos. The whole content of [https://nicegui.io](https:
+//nicegui.io) is [implemented with NiceGUI itself](https://github.com/
+zauberzeug/nicegui/blob/main/main.py). You may also have a look at our [in-
+depth examples](https://github.com/zauberzeug/nicegui/tree/main/examples) of
+what you can do with NiceGUI. ## Why? We at [Zauberzeug](https://
+zauberzeug.com) like [Streamlit](https://streamlit.io/) but find it does [too
+much magic](https://github.com/zauberzeug/nicegui/issues/1#issuecomment-
+847413651) when it comes to state handling. In search for an alternative nice
+library to write simple graphical user interfaces in Python we discovered
+[JustPy](https://justpy.io/). Although we liked the approach, it is too "low-
+level HTML" for our daily usage. But it inspired us to use [Vue](https://
+vuejs.org/) and [Quasar](https://quasar.dev/) for the frontend. We have built
+on top of [FastAPI](https://fastapi.tiangolo.com/), which itself is based on
+the ASGI framework [Starlette](https://www.starlette.io/) and the ASGI
+webserver [Uvicorn](https://www.uvicorn.org/) because of their great
+performance and ease of use. ## Contributing Thank you for your interest in
+contributing to NiceGUI! We are thrilled to have you on board and appreciate
+your efforts to make this project even better. As a growing open-source
+project, we understand that it takes a community effort to achieve our goals.
+That's why we welcome all kinds of contributions, no matter how small or big
+they are. Whether it's adding new features, fixing bugs, improving
+documentation, or suggesting new ideas, we believe that every contribution
+counts and adds value to our project. We have provided a detailed guide on how
+to contribute to NiceGUI in our [CONTRIBUTING.md](https://github.com/
+zauberzeug/nicegui/blob/main/CONTRIBUTING.md) file. We encourage you to read it
+carefully before making any contributions to ensure that your work aligns with
+the project's goals and standards. If you have any questions or need help with
+anything, please don't hesitate to reach out to us. We are always here to
+support and guide you through the contribution process. ### Included Web
+Dependencies See [DEPENDENCIES.md](https://github.com/zauberzeug/nicegui/blob/
+main/DEPENDENCIES.md) for a list of web frameworks NiceGUI depends on.
```

### Comparing `nicegui-1.2.7/nicegui/app.py` & `nicegui-1.2.8/nicegui/app.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/background_tasks.py` & `nicegui-1.2.8/nicegui/background_tasks.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/binding.py` & `nicegui-1.2.8/nicegui/binding.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/client.py` & `nicegui-1.2.8/nicegui/client.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/colors.py` & `nicegui-1.2.8/nicegui/colors.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/dependencies.py` & `nicegui-1.2.8/nicegui/dependencies.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/element.py` & `nicegui-1.2.8/nicegui/element.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/aggrid.js` & `nicegui-1.2.8/nicegui/elements/aggrid.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/aggrid.py` & `nicegui-1.2.8/nicegui/elements/aggrid.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/audio.py` & `nicegui-1.2.8/nicegui/elements/audio.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/avatar.py` & `nicegui-1.2.8/nicegui/elements/avatar.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/badge.py` & `nicegui-1.2.8/nicegui/elements/badge.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/button.py` & `nicegui-1.2.8/nicegui/elements/button.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/card.py` & `nicegui-1.2.8/nicegui/elements/card.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/chart.js` & `nicegui-1.2.8/nicegui/elements/chart.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/chart.py` & `nicegui-1.2.8/nicegui/elements/chart.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/checkbox.py` & `nicegui-1.2.8/nicegui/elements/checkbox.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/choice_element.py` & `nicegui-1.2.8/nicegui/elements/choice_element.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/color_input.py` & `nicegui-1.2.8/nicegui/elements/color_input.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/color_picker.py` & `nicegui-1.2.8/nicegui/elements/color_picker.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/colors.py` & `nicegui-1.2.8/nicegui/elements/colors.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/date.py` & `nicegui-1.2.8/nicegui/elements/date.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/dialog.py` & `nicegui-1.2.8/nicegui/elements/dialog.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/expansion.py` & `nicegui-1.2.8/nicegui/elements/expansion.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/html.py` & `nicegui-1.2.8/nicegui/elements/html.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/icon.py` & `nicegui-1.2.8/nicegui/elements/icon.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/input.py` & `nicegui-1.2.8/nicegui/elements/input.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/interactive_image.js` & `nicegui-1.2.8/nicegui/elements/interactive_image.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/interactive_image.py` & `nicegui-1.2.8/nicegui/elements/interactive_image.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/joystick.py` & `nicegui-1.2.8/nicegui/elements/joystick.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/joystick.vue` & `nicegui-1.2.8/nicegui/elements/joystick.vue`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/keyboard.js` & `nicegui-1.2.8/nicegui/elements/keyboard.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/keyboard.py` & `nicegui-1.2.8/nicegui/elements/keyboard.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/knob.py` & `nicegui-1.2.8/nicegui/elements/knob.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/CSS2DRenderer.js` & `nicegui-1.2.8/nicegui/elements/lib/CSS2DRenderer.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/CSS3DRenderer.js` & `nicegui-1.2.8/nicegui/elements/lib/CSS3DRenderer.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/OrbitControls.js` & `nicegui-1.2.8/nicegui/elements/lib/OrbitControls.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/STLLoader.js` & `nicegui-1.2.8/nicegui/elements/lib/STLLoader.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/ag-grid-community.min.js` & `nicegui-1.2.8/nicegui/elements/lib/ag-grid-community.min.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts-3d.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts-3d.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts-more.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts-more.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/accessibility.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/accessibility.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/annotations-advanced.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/annotations-advanced.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/annotations.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/annotations.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/arc-diagram.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/arc-diagram.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/arrow-symbols.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/arrow-symbols.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/boost-canvas.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/boost-canvas.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/boost.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/boost.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/broken-axis.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/broken-axis.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/bullet.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/bullet.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/coloraxis.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/coloraxis.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/current-date-indicator.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/current-date-indicator.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/cylinder.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/cylinder.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/data.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/data.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/datagrouping.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/datagrouping.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/debugger.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/debugger.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/dependency-wheel.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/dependency-wheel.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/dotplot.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/dotplot.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/drag-panes.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/drag-panes.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/draggable-points.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/draggable-points.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/drilldown.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/drilldown.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/dumbbell.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/dumbbell.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/export-data.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/export-data.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/exporting.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/exporting.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/full-screen.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/full-screen.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/funnel.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/funnel.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/funnel3d.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/funnel3d.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/gantt.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/gantt.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/grid-axis.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/grid-axis.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/heatmap.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/heatmap.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/heikinashi.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/heikinashi.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/histogram-bellcurve.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/histogram-bellcurve.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/hollowcandlestick.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/hollowcandlestick.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/item-series.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/item-series.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/lollipop.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/lollipop.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/marker-clusters.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/marker-clusters.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/networkgraph.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/networkgraph.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/no-data-to-display.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/no-data-to-display.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/offline-exporting.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/offline-exporting.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/oldie-polyfills.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/oldie-polyfills.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/oldie.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/oldie.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/organization.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/organization.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/overlapping-datalabels.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/overlapping-datalabels.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/parallel-coordinates.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/parallel-coordinates.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/pareto.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/pareto.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/pathfinder.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/pathfinder.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/pattern-fill.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/pattern-fill.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/price-indicator.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/price-indicator.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/pyramid3d.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/pyramid3d.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/sankey.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/sankey.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/series-label.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/series-label.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/series-on-point.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/series-on-point.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/solid-gauge.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/solid-gauge.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/sonification.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/sonification.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/static-scale.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/static-scale.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/stock-tools.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/stock-tools.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/stock.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/stock.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/streamgraph.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/streamgraph.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/sunburst.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/sunburst.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/tilemap.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/tilemap.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/timeline.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/timeline.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/treegraph.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/treegraph.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/treegrid.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/treegrid.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/treemap.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/treemap.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/variable-pie.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/variable-pie.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/variwide.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/variwide.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/vector.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/vector.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/venn.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/venn.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/windbarb.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/windbarb.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/wordcloud.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/wordcloud.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/highcharts_modules/xrange.js` & `nicegui-1.2.8/nicegui/elements/lib/highcharts_modules/xrange.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/mermaid.min.js` & `nicegui-1.2.8/nicegui/elements/lib/mermaid.min.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/nipplejs.min.js` & `nicegui-1.2.8/nicegui/elements/lib/nipplejs.min.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/plotly.min.js` & `nicegui-1.2.8/nicegui/elements/lib/plotly.min.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/three.min.js` & `nicegui-1.2.8/nicegui/elements/lib/three.min.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/lib/tween.umd.min.js` & `nicegui-1.2.8/nicegui/elements/lib/tween.umd.min.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/line_plot.py` & `nicegui-1.2.8/nicegui/elements/line_plot.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/link.py` & `nicegui-1.2.8/nicegui/elements/link.py`
...
### Comparing `nicegui-1.2.7/nicegui/elements/log.js` & `nicegui-1.2.8/nicegui/elements/log.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/log.py` & `nicegui-1.2.8/nicegui/elements/log.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/markdown.js` & `nicegui-1.2.8/nicegui/elements/markdown.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/markdown.py` & `nicegui-1.2.8/nicegui/elements/markdown.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/menu.py` & `nicegui-1.2.8/nicegui/elements/menu.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/mermaid.py` & `nicegui-1.2.8/nicegui/elements/mermaid.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/mixins/content_element.py` & `nicegui-1.2.8/nicegui/elements/mixins/content_element.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/mixins/filter_element.py` & `nicegui-1.2.8/nicegui/elements/mixins/filter_element.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/mixins/source_element.py` & `nicegui-1.2.8/nicegui/elements/mixins/source_element.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/mixins/text_element.py` & `nicegui-1.2.8/nicegui/elements/mixins/text_element.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/mixins/value_element.py` & `nicegui-1.2.8/nicegui/elements/mixins/value_element.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/mixins/visibility.py` & `nicegui-1.2.8/nicegui/elements/mixins/visibility.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/number.py` & `nicegui-1.2.8/nicegui/elements/number.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/plotly.py` & `nicegui-1.2.8/nicegui/elements/plotly.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/plotly.vue` & `nicegui-1.2.8/nicegui/elements/plotly.vue`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/progress.py` & `nicegui-1.2.8/nicegui/elements/progress.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/pyplot.py` & `nicegui-1.2.8/nicegui/elements/pyplot.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/query.js` & `nicegui-1.2.8/nicegui/elements/query.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/query.py` & `nicegui-1.2.8/nicegui/elements/query.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/radio.py` & `nicegui-1.2.8/nicegui/elements/radio.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/scene.js` & `nicegui-1.2.8/nicegui/elements/scene.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/scene.py` & `nicegui-1.2.8/nicegui/elements/scene.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/scene_object3d.py` & `nicegui-1.2.8/nicegui/elements/scene_object3d.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/scene_objects.py` & `nicegui-1.2.8/nicegui/elements/scene_objects.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/select.js` & `nicegui-1.2.8/nicegui/elements/select.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/select.py` & `nicegui-1.2.8/nicegui/elements/select.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/slider.py` & `nicegui-1.2.8/nicegui/elements/slider.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/spinner.py` & `nicegui-1.2.8/nicegui/elements/spinner.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/splitter.py` & `nicegui-1.2.8/nicegui/elements/splitter.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/switch.py` & `nicegui-1.2.8/nicegui/elements/switch.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/table.py` & `nicegui-1.2.8/nicegui/elements/table.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/tabs.py` & `nicegui-1.2.8/nicegui/elements/tabs.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/textarea.py` & `nicegui-1.2.8/nicegui/elements/textarea.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/time.py` & `nicegui-1.2.8/nicegui/elements/time.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/toggle.py` & `nicegui-1.2.8/nicegui/elements/toggle.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/tree.py` & `nicegui-1.2.8/nicegui/elements/tree.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/upload.py` & `nicegui-1.2.8/nicegui/elements/upload.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/elements/video.py` & `nicegui-1.2.8/nicegui/elements/video.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/error.py` & `nicegui-1.2.8/nicegui/error.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/event_listener.py` & `nicegui-1.2.8/nicegui/event_listener.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/events.py` & `nicegui-1.2.8/nicegui/events.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/functions/javascript.py` & `nicegui-1.2.8/nicegui/functions/javascript.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/functions/notify.py` & `nicegui-1.2.8/nicegui/functions/notify.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/functions/open.py` & `nicegui-1.2.8/nicegui/functions/open.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/functions/timer.py` & `nicegui-1.2.8/nicegui/functions/timer.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/globals.py` & `nicegui-1.2.8/nicegui/globals.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/helpers.py` & `nicegui-1.2.8/nicegui/helpers.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/json/__init__.py` & `nicegui-1.2.8/nicegui/json/__init__.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/json/builtin_wrapper.py` & `nicegui-1.2.8/nicegui/json/builtin_wrapper.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/json/orjson_wrapper.py` & `nicegui-1.2.8/nicegui/json/orjson_wrapper.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/native_mode.py` & `nicegui-1.2.8/nicegui/native_mode.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/nicegui.py` & `nicegui-1.2.8/nicegui/nicegui.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/outbox.py` & `nicegui-1.2.8/nicegui/outbox.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/page.py` & `nicegui-1.2.8/nicegui/page.py`
...
### Comparing `nicegui-1.2.7/nicegui/page_layout.py` & `nicegui-1.2.8/nicegui/page_layout.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/run.py` & `nicegui-1.2.8/nicegui/run.py`
...
### Comparing `nicegui-1.2.7/nicegui/run_with.py` & `nicegui-1.2.8/nicegui/run_with.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/slot.py` & `nicegui-1.2.8/nicegui/slot.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/favicon.ico` & `nicegui-1.2.8/nicegui/static/favicon.ico`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxEIzIXKMnyrYk.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxEIzIXKMnyrYk.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxFIzIXKMnyrYk.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxFIzIXKMnyrYk.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxGIzIXKMnyrYk.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxGIzIXKMnyrYk.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxHIzIXKMnyrYk.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxHIzIXKMnyrYk.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxIIzIXKMny.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxIIzIXKMny.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxLIzIXKMnyrYk.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxLIzIXKMnyrYk.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxMIzIXKMnyrYk.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOkCnqEu92Fr1MmgVxMIzIXKMnyrYk.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fABc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fABc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fBBc4AMP6lQ.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fBBc4AMP6lQ.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fBxc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fBxc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fCBc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fCBc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fCRc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fCRc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fChc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fChc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fCxc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmEU9fCxc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fABc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fABc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fBBc4AMP6lQ.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fBBc4AMP6lQ.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fBxc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fBxc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fCBc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fCBc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fCRc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fCRc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fChc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fChc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fCxc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmSU5fCxc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfABc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfABc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfBBc4AMP6lQ.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfBBc4AMP6lQ.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfBxc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfBxc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfCBc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfCBc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfCRc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfCRc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfChc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfChc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfCxc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmWUlfCxc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfABc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfABc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfBBc4AMP6lQ.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfBBc4AMP6lQ.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfBxc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfBxc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfCBc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfCBc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfCRc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfCRc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfChc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfChc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfCxc4AMP6lbBP.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOlCnqEu92Fr1MmYUtfCxc4AMP6lbBP.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOmCnqEu92Fr1Mu4WxKKTU1Kvnz.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOmCnqEu92Fr1Mu4WxKKTU1Kvnz.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOmCnqEu92Fr1Mu4mxKKTU1Kg.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOmCnqEu92Fr1Mu4mxKKTU1Kg.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOmCnqEu92Fr1Mu5mxKKTU1Kvnz.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOmCnqEu92Fr1Mu5mxKKTU1Kvnz.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOmCnqEu92Fr1Mu72xKKTU1Kvnz.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOmCnqEu92Fr1Mu72xKKTU1Kvnz.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOmCnqEu92Fr1Mu7GxKKTU1Kvnz.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOmCnqEu92Fr1Mu7GxKKTU1Kvnz.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOmCnqEu92Fr1Mu7WxKKTU1Kvnz.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOmCnqEu92Fr1Mu7WxKKTU1Kvnz.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/KFOmCnqEu92Fr1Mu7mxKKTU1Kvnz.woff2` & `nicegui-1.2.8/nicegui/static/fonts/KFOmCnqEu92Fr1Mu7mxKKTU1Kvnz.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts/flUhRq6tzZclQEJ-Vdg-IuiaDsNcIhQ8tQ.woff2` & `nicegui-1.2.8/nicegui/static/fonts/flUhRq6tzZclQEJ-Vdg-IuiaDsNcIhQ8tQ.woff2`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/fonts.css` & `nicegui-1.2.8/nicegui/static/fonts.css`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/nicegui.css` & `nicegui-1.2.8/nicegui/static/nicegui.css`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/quasar.prod.css` & `nicegui-1.2.8/nicegui/static/quasar.prod.css`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/quasar.umd.prod.js` & `nicegui-1.2.8/nicegui/static/quasar.umd.prod.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/sad_face.svg` & `nicegui-1.2.8/nicegui/static/sad_face.svg`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/socket.io.min.js` & `nicegui-1.2.8/nicegui/static/socket.io.min.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/tailwindcss.min.js` & `nicegui-1.2.8/nicegui/static/tailwindcss.min.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/vue.global.prod.js` & `nicegui-1.2.8/nicegui/static/vue.global.prod.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/static/vue.min.js` & `nicegui-1.2.8/nicegui/static/vue.min.js`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind.py` & `nicegui-1.2.8/nicegui/tailwind.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/accent_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/accent_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/background_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/background_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/border_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/border_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/border_radius.py` & `nicegui-1.2.8/nicegui/tailwind_types/border_radius.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/border_spacing.py` & `nicegui-1.2.8/nicegui/tailwind_types/border_spacing.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/border_width.py` & `nicegui-1.2.8/nicegui/tailwind_types/border_width.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/box_shadow_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/box_shadow_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/caret_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/caret_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/cursor.py` & `nicegui-1.2.8/nicegui/tailwind_types/cursor.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/divide_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/divide_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/fill.py` & `nicegui-1.2.8/nicegui/tailwind_types/fill.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/flex_basis.py` & `nicegui-1.2.8/nicegui/tailwind_types/flex_basis.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/gap.py` & `nicegui-1.2.8/nicegui/tailwind_types/gap.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/gradient_color_stops.py` & `nicegui-1.2.8/nicegui/tailwind_types/gradient_color_stops.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/grid_column_start_end.py` & `nicegui-1.2.8/nicegui/tailwind_types/grid_column_start_end.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/height.py` & `nicegui-1.2.8/nicegui/tailwind_types/height.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/margin.py` & `nicegui-1.2.8/nicegui/tailwind_types/margin.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/outline_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/outline_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/padding.py` & `nicegui-1.2.8/nicegui/tailwind_types/padding.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/ring_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/ring_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/ring_offset_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/ring_offset_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/scroll_margin.py` & `nicegui-1.2.8/nicegui/tailwind_types/scroll_margin.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/scroll_padding.py` & `nicegui-1.2.8/nicegui/tailwind_types/scroll_padding.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/space_between.py` & `nicegui-1.2.8/nicegui/tailwind_types/space_between.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/stroke.py` & `nicegui-1.2.8/nicegui/tailwind_types/stroke.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/text_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/text_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/text_decoration_color.py` & `nicegui-1.2.8/nicegui/tailwind_types/text_decoration_color.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/top_right_bottom_left.py` & `nicegui-1.2.8/nicegui/tailwind_types/top_right_bottom_left.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/translate.py` & `nicegui-1.2.8/nicegui/tailwind_types/translate.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/tailwind_types/width.py` & `nicegui-1.2.8/nicegui/tailwind_types/width.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/templates/index.html` & `nicegui-1.2.8/nicegui/templates/index.html`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/nicegui/ui.py` & `nicegui-1.2.8/nicegui/ui.py`

 * *Files identical despite different names*

### Comparing `nicegui-1.2.7/pyproject.toml` & `nicegui-1.2.8/pyproject.toml`
...
### Comparing `nicegui-1.2.7/setup.py` & `nicegui-1.2.8/setup.py`
...
@@ -44,52 +44,54 @@
 virtual joysticks\n - annotate and overlay images\n - interact with tables\n -
 navigate foldable tree structures\n- built-in timer to refresh data in
 intervals (even every 10 ms)\n- straight-forward data binding to write even
 less code\n- notifications, dialogs and menus to provide state of the art user
...
-nicegui\n```\n\n## Usage\n\nWrite your nice GUI in a file `main.py`:
-\n\n```python\nfrom nicegui import ui\n\nui.label(\'Hello
-NiceGUI!\')\nui.button(\'BUTTON\', on_click=lambda: ui.notify(\'button was
-pressed\'))\n\nui.run()\n```\n\nLaunch it with:\n\n```bash\npython3
-main.py\n```\n\nThe GUI is now available through http://localhost:8080/ in your
-browser.\nNote: NiceGUI will automatically reload the page when you modify the
-code.\n\n## Documentation and Examples\n\nThe documentation is hosted at
-[https://nicegui.io/documentation](https://nicegui.io/documentation) and
-provides plenty of live demos.\nThe whole content of [https://nicegui.io]
-(https://nicegui.io) is [implemented with NiceGUI itself](https://github.com/
-zauberzeug/nicegui/blob/main/main.py).\n\nYou may also have a look at our [in-
-depth examples](https://github.com/zauberzeug/nicegui/tree/main/examples) of
-what you can do with NiceGUI.\n\n## Why?\n\nWe at [Zauberzeug](https://
-zauberzeug.com) like [Streamlit](https://streamlit.io/)\nbut find it does [too
-much magic](https://github.com/zauberzeug/nicegui/issues/1#issuecomment-
-847413651) when it comes to state handling.\nIn search for an alternative nice
-library to write simple graphical user interfaces in Python we discovered
-[JustPy](https://justpy.io/).\nAlthough we liked the approach, it is too "low-
-level HTML" for our daily usage.\nBut it inspired us to use [Vue](https://
-vuejs.org/) and [Quasar](https://quasar.dev/) for the frontend.\n\nWe have
-built on top of [FastAPI](https://fastapi.tiangolo.com/),\nwhich itself is
-based on the ASGI framework [Starlette](https://www.starlette.io/)\nand the
-ASGI webserver [Uvicorn](https://www.uvicorn.org/)\nbecause of their great
-performance and ease of use.\n\n## Contributing\n\nThank you for your interest
-in contributing to NiceGUI! We are thrilled to have you on board and appreciate
-your efforts to make this project even better.\n\nAs a growing open-source
-project, we understand that it takes a community effort to achieve our goals.
-That\'s why we welcome all kinds of contributions, no matter how small or big
-they are. Whether it\'s adding new features, fixing bugs, improving
-documentation, or suggesting new ideas, we believe that every contribution
-counts and adds value to our project.\n\nWe have provided a detailed guide on
-how to contribute to NiceGUI in our [CONTRIBUTING.md](https://github.com/
-zauberzeug/nicegui/blob/main/CONTRIBUTING.md) file. We encourage you to read it
-carefully before making any contributions to ensure that your work aligns with
-the project\'s goals and standards.\n\nIf you have any questions or need help
-with anything, please don\'t hesitate to reach out to us. We are always here to
-support and guide you through the contribution process.\n\n### Included Web
-Dependencies\n\nSee [DEPENDENCIES.md](https://github.com/zauberzeug/nicegui/
-blob/main/DEPENDENCIES.md) for a list of web frameworks NiceGUI depends on.\n',
-'author': 'Zauberzeug GmbH', 'author_email': 'info@zauberzeug.com',
-'maintainer': 'None', 'maintainer_email': 'None', 'url': 'https://github.com/
-zauberzeug/nicegui', 'packages': packages, 'package_data': package_data,
-'install_requires': install_requires, 'extras_require': extras_require,
-'python_requires': '>=3.7,<4.0', } setup(**setup_kwargs)
+events and session data\n- runs in Jupyter Notebooks and allows Python\'s
+interactive mode\n- auto-complete support for Tailwind CSS\n\n##
+Installation\n\n```bash\npython3 -m pip install nicegui\n```\n\n##
+Usage\n\nWrite your nice GUI in a file `main.py`:\n\n```python\nfrom nicegui
+import ui\n\nui.label(\'Hello NiceGUI!\')\nui.button(\'BUTTON\',
+on_click=lambda: ui.notify(\'button was pressed\'))\n\nui.run()\n```\n\nLaunch
+it with:\n\n```bash\npython3 main.py\n```\n\nThe GUI is now available through
+http://localhost:8080/ in your browser.\nNote: NiceGUI will automatically
+reload the page when you modify the code.\n\n## Documentation and
+Examples\n\nThe documentation is hosted at [https://nicegui.io/documentation]
+(https://nicegui.io/documentation) and provides plenty of live demos.\nThe
+whole content of [https://nicegui.io](https://nicegui.io) is [implemented with
+NiceGUI itself](https://github.com/zauberzeug/nicegui/blob/main/
+main.py).\n\nYou may also have a look at our [in-depth examples](https://
+github.com/zauberzeug/nicegui/tree/main/examples) of what you can do with
+NiceGUI.\n\n## Why?\n\nWe at [Zauberzeug](https://zauberzeug.com) like
+[Streamlit](https://streamlit.io/)\nbut find it does [too much magic](https://
+github.com/zauberzeug/nicegui/issues/1#issuecomment-847413651) when it comes to
+state handling.\nIn search for an alternative nice library to write simple
+graphical user interfaces in Python we discovered [JustPy](https://justpy.io/
+).\nAlthough we liked the approach, it is too "low-level HTML" for our daily
+usage.\nBut it inspired us to use [Vue](https://vuejs.org/) and [Quasar](https:
+//quasar.dev/) for the frontend.\n\nWe have built on top of [FastAPI](https://
+fastapi.tiangolo.com/),\nwhich itself is based on the ASGI framework
+[Starlette](https://www.starlette.io/)\nand the ASGI webserver [Uvicorn](https:
+//www.uvicorn.org/)\nbecause of their great performance and ease of use.\n\n##
+Contributing\n\nThank you for your interest in contributing to NiceGUI! We are
+thrilled to have you on board and appreciate your efforts to make this project
+even better.\n\nAs a growing open-source project, we understand that it takes a
+community effort to achieve our goals. That\'s why we welcome all kinds of
+contributions, no matter how small or big they are. Whether it\'s adding new
+features, fixing bugs, improving documentation, or suggesting new ideas, we
+believe that every contribution counts and adds value to our project.\n\nWe
+have provided a detailed guide on how to contribute to NiceGUI in our
+[CONTRIBUTING.md](https://github.com/zauberzeug/nicegui/blob/main/
+CONTRIBUTING.md) file. We encourage you to read it carefully before making any
+contributions to ensure that your work aligns with the project\'s goals and
+standards.\n\nIf you have any questions or need help with anything, please
+don\'t hesitate to reach out to us. We are always here to support and guide you
+through the contribution process.\n\n### Included Web Dependencies\n\nSee
+[DEPENDENCIES.md](https://github.com/zauberzeug/nicegui/blob/main/
+DEPENDENCIES.md) for a list of web frameworks NiceGUI depends on.\n', 'author':
+'Zauberzeug GmbH', 'author_email': 'info@zauberzeug.com', 'maintainer': 'None',
+'maintainer_email': 'None', 'url': 'https://github.com/zauberzeug/nicegui',
...
### Comparing `nicegui-1.2.7/PKG-INFO` & `nicegui-1.2.8/PKG-INFO`
