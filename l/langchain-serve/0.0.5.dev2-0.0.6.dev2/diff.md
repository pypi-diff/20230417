# Comparing `tmp/langchain-serve-0.0.5.dev2.tar.gz` & `tmp/langchain-serve-0.0.6.dev2.tar.gz`
...
### Comparing `langchain-serve-0.0.5.dev2/LICENSE` & `langchain-serve-0.0.6.dev2/LICENSE`
