# Comparing `tmp/langchain-serve-0.0.4.dev8.tar.gz` & `tmp/langchain-serve-0.0.4.dev9.tar.gz`
...
### Comparing `langchain-serve-0.0.4.dev8/LICENSE` & `langchain-serve-0.0.4.dev9/LICENSE`
