# Comparing `tmp/flask-fd-1.0.5.tar.gz` & `tmp/flask-fd-1.1.0.tar.gz`
...
## Comparing `flask-fd-1.0.5.tar` & `flask-fd-1.1.0.tar`
...
### Comparing `flask-fd-1.0.5/LICENSE.md` & `flask-fd-1.1.0/LICENSE.md`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/PKG-INFO` & `flask-fd-1.1.0/PKG-INFO`
...
### Comparing `flask-fd-1.0.5/README.md` & `flask-fd-1.1.0/README.md`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/__main__.py` & `flask-fd-1.1.0/flask_fd/__main__.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/cmd.py` & `flask-fd-1.1.0/flask_fd/cmd.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/gui/builder.py` & `flask-fd-1.1.0/flask_fd/gui/builder.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/gui/containers.py` & `flask-fd-1.1.0/flask_fd/gui/containers.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/gui/indicators.py` & `flask-fd-1.1.0/flask_fd/gui/indicators.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/gui/menus.py` & `flask-fd-1.1.0/flask_fd/gui/menus.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/launchers/launchers.py` & `flask-fd-1.1.0/flask_fd/launchers/launchers.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/plop/flask/main_flask_fd_1.py` & `flask-fd-1.1.0/flask_fd/plop/flask/main_flask_fd_1.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/plop/flask/main_flask_fd_2.py` & `flask-fd-1.1.0/flask_fd/plop/flask/main_flask_fd_2.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/plop/flask/main_flask_fd_3.py` & `flask-fd-1.1.0/flask_fd/plop/flask/main_flask_fd_3.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/plop/flask/starter/FlaskFdIcon` & `flask-fd-1.1.0/flask_fd/plop/flask/starter/flaskapp/app/static/img/FlaskFdIcon`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/plop/flask/starter/flask_for_desktop.py` & `flask-fd-1.1.0/flask_fd/plop/flask/starter/flask_for_desktop.py`

 * *Files identical despite different names*

### Comparing `flask-fd-1.0.5/flask_fd/plop/ploppers.py` & `flask-fd-1.1.0/flask_fd/plop/ploppers.py`
...
### Comparing `flask-fd-1.0.5/flask_fd.egg-info/PKG-INFO` & `flask-fd-1.1.0/flask_fd.egg-info/PKG-INFO`
...
### Comparing `flask-fd-1.0.5/flask_fd.egg-info/SOURCES.txt` & `flask-fd-1.1.0/flask_fd.egg-info/SOURCES.txt`
...
+flask_fd/plop/flask/starter/__init__.py
...
+flask_fd/plop/flask/starter/flaskapp/app/static/__init__.py
+flask_fd/plop/flask/starter/flaskapp/app/static/css/__init__.py
+flask_fd/plop/flask/starter/flaskapp/app/static/img/FlaskFdIcon
+flask_fd/plop/flask/starter/flaskapp/app/static/img/__init__.py
+flask_fd/plop/flask/starter/flaskapp/app/static/js/__init__.py
+flask_fd/plop/flask/starter/flaskapp/app/templates/__init__.py
+flask_fd/plop/flask/starter/flaskapp/app/templates/_base.html
+flask_fd/plop/flask/starter/flaskapp/app/templates/index.html
```

### Comparing `flask-fd-1.0.5/setup.py` & `flask-fd-1.1.0/setup.py`
