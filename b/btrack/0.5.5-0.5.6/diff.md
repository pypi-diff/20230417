# Comparing `tmp/btrack-0.5.5.tar.gz` & `tmp/btrack-0.5.6.tar.gz`
...
### Comparing `btrack-0.5.5/.github/workflows/deploy.yml` & `btrack-0.5.6/.github/workflows/deploy.yml`
...
### Comparing `btrack-0.5.5/btrack/libwrapper.py` & `btrack-0.5.6/btrack/libwrapper.py`
...
### Comparing `btrack-0.5.5/btrack/src/inference.cc` & `btrack-0.5.6/btrack/src/inference.cc`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/btrack/src/interface.cc` & `btrack-0.5.6/btrack/src/interface.cc`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/btrack/src/manager.cc` & `btrack-0.5.6/btrack/src/manager.cc`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/btrack/src/motion.cc` & `btrack-0.5.6/btrack/src/motion.cc`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/btrack/src/pdf.cc` & `btrack-0.5.6/btrack/src/pdf.cc`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/btrack/src/tracker.cc` & `btrack-0.5.6/btrack/src/tracker.cc`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/btrack/src/tracklet.cc` & `btrack-0.5.6/btrack/src/tracklet.cc`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/btrack/src/wrapper.cc` & `btrack-0.5.6/btrack/src/wrapper.cc`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/btrack/utils.py` & `btrack-0.5.6/btrack/utils.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/btrack.egg-info/PKG-INFO` & `btrack-0.5.6/btrack.egg-info/PKG-INFO`
...
### Comparing `btrack-0.5.5/btrack.egg-info/SOURCES.txt` & `btrack-0.5.6/btrack.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/Makefile` & `btrack-0.5.6/docs/Makefile`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/_static/btrack_logo.png` & `btrack-0.5.6/docs/_static/btrack_logo.png`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/about.rst` & `btrack-0.5.6/docs/about.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/conf.py` & `btrack-0.5.6/docs/conf.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/dev_guide/index.rst` & `btrack-0.5.6/docs/dev_guide/index.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/index.rst` & `btrack-0.5.6/docs/index.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/make.bat` & `btrack-0.5.6/docs/make.bat`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/user_guide/configuration.rst` & `btrack-0.5.6/docs/user_guide/configuration.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/user_guide/installation.rst` & `btrack-0.5.6/docs/user_guide/installation.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/user_guide/large_datasets.rst` & `btrack-0.5.6/docs/user_guide/large_datasets.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/user_guide/napari.rst` & `btrack-0.5.6/docs/user_guide/napari.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/user_guide/saving_tracks.rst` & `btrack-0.5.6/docs/user_guide/saving_tracks.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/user_guide/simple_example.rst` & `btrack-0.5.6/docs/user_guide/simple_example.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/docs/user_guide/using_features.rst` & `btrack-0.5.6/docs/user_guide/using_features.rst`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/examples/example_tracking_pipeline-features.ipynb` & `btrack-0.5.6/examples/example_tracking_pipeline-features.ipynb`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/examples/example_tracking_pipeline.ipynb` & `btrack-0.5.6/examples/example_tracking_pipeline.ipynb`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/models/cell_config.json` & `btrack-0.5.6/models/cell_config.json`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/models/cell_config_flat.json` & `btrack-0.5.6/models/cell_config_flat.json`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/models/particle_config.json` & `btrack-0.5.6/models/particle_config.json`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/pyproject.toml` & `btrack-0.5.6/pyproject.toml`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/_test_data/test_data.csv` & `btrack-0.5.6/tests/_test_data/test_data.csv`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/_test_data/test_ground_truth.json` & `btrack-0.5.6/tests/_test_data/test_ground_truth.json`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/_utils.py` & `btrack-0.5.6/tests/_utils.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/conftest.py` & `btrack-0.5.6/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/napari/test_dock_widget.py` & `btrack-0.5.6/tests/napari/test_dock_widget.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/test_config.py` & `btrack-0.5.6/tests/test_config.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/test_io.py` & `btrack-0.5.6/tests/test_io.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/test_models.py` & `btrack-0.5.6/tests/test_models.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/test_tracker.py` & `btrack-0.5.6/tests/test_tracker.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/test_tracklets.py` & `btrack-0.5.6/tests/test_tracklets.py`

 * *Files identical despite different names*

### Comparing `btrack-0.5.5/tests/test_utils.py` & `btrack-0.5.6/tests/test_utils.py`
